...
class OutfitTransformerEmbeddingModel(nn.Module):
    def __init__(
        ...
        # Image Encoder
        self.image_encoder = vit_b_16(weights=ViT_B_16_Weights.DEFAULT)
        self.image_encoder.heads.head = nn.Linear(self.image_encoder.heads.head.in_features, self.encoder_hidden, bias=False)
